<form wire:submit.prevent='submit' class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4  md:p-8 space-y-8">
    ...
    <div class="block mt-4">
        <label for="live" class="inline-flex items-center">
            <input id="live" wire:model.lazy='state.live' type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="live">
